...
const ExitItem = ({fromRoute}) => {
  ...
  return (
    // Opens "from" link
    <div onClick={() => Router.back()} className="flex items-center justify-center aspect-square w-[50px] bg-opposite bg-opacity-20 rounded-full hover:bg-opacity-40 hover:cursor-pointer transition-colors duration-200">
