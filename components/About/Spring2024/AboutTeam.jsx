      ...
      <div className="flex items-center max-xl:flex-col max-xl:space-y-20 xl:space-x-10 2xl:space-x-40">
        ...
        <div className="max-w-[500px] space-y-5 max-lg:w-[85vw]">
          ...
          <p className="text-base font-normal">
            ...
            control of the technical infrastructure. He configured a serverless
            hosting solution, designed and managed sophisticated databases, and
            developed efficient APIs utilizing a stack involving Next.js, AWS,
            and SST.
          </p>
        </div>
