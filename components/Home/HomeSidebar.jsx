...
const HomeSidebar = ({sidebarClosed, setSidebarClosed}) => {
  ...
  return (
    <div className={`fixed top-0 left-0 text-primary bg-primary w-[300px] drop-shadow-xl h-full ${sidebarClosed ? "w-[30px]" : ""} transition-all duration-300 overflow-hidden`}>
